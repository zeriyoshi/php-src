...
#define phpext_php_random_ptr &php_random_module_entry
...
PHPAPI uint64_t php_random_next(php_random *php_random, bool shift);
PHPAPI zend_long php_random_range(php_random *php_random, zend_long min, zend_long max);
PHPAPI void php_random_array_data_shuffle(php_random *php_random, zval *array);
PHPAPI void php_random_string_shuffle(php_random *php_random, char *str, zend_long len);
