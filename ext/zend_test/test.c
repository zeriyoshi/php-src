...
static ZEND_FUNCTION(zend_test_zpp_mismatch)
{
	zend_long foo;
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_zend_test_zpp_mismatch, 0, 0, IS_VOID, 0)
ZEND_END_ARG_INFO()

static const zend_function_entry ext_function_legacy[] = {
	ZEND_FE(zend_iterable_legacy, arginfo_zend_iterable_legacy)
	ZEND_FE(zend_test_zpp_mismatch, arginfo_zend_test_zpp_mismatch)
	ZEND_FE_END
};
